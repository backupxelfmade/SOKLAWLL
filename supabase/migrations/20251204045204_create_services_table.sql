/*
  ...
  1. New Tables
    - `services`
      ...
      - `overview` (text)
      - `header_image` (text)
      - `key_services` (text) - Comma-separated list
      - `why_choose_us_1_title`, `why_choose_us_1_description` (text)
      - `why_choose_us_2_title`, `why_choose_us_2_description` (text)
      - `why_choose_us_3_title`, `why_choose_us_3_description` (text)
      - `process_step_1_title`, `process_step_1_description` (text)
      - `process_step_2_title`, `process_step_2_description` (text)
      - `process_step_3_title`, `process_step_3_description` (text)
      - `process_step_4_title`, `process_step_4_description` (text)
      - `process_step_5_title`, `process_step_5_description` (text)
      - `is_active` (boolean)
  ...
  2. Security
    ...
    - Add policy for authenticated users to manage all services
